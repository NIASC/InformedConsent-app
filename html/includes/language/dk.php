...
'storebox_email_notification' => 'Du vil modtage et link
...
'contact_me' => 'Kontakt mig venligt hvis projektet
udvides (Dette kunne være en app der kan rådgive dig om dine indkøb eller hvis
vi vil benytte andre datakilder end de nævnte)',

'newslatter_text' => 'Send mig nyheder om projektet',

'request_nemid' => 'Underskriv med NEM ID',

'questionnaire_error' => 'Svaret er desværre forkert',
...
tid tilmelde dig igen, men data du tidligere har indtastet vil være gået tabt",

'windraw_email_not_found' => "Bruger med denne e-mail
fandtes ikke",
...
'storebox_empty_email' => " Email feltet skal
udfyldes!",

'verify_nemid' => 'brug venligt nem-id til at verificere!',

'phone_again' => "telefon nummeret skal matche det
du skrev ovenfor!",

'email_doesnt_match' => " email skal matche det du
skrev ovenfor!",

'phone_doesnt_match' => " telefon nummeret skal
matche det du skrev ovenfor!",

'questionary_incorrect' => 'svaret er ikke korrekt',

'unique_phone' => "dette nummer er allerede i vores
database",

'storebox_unique_phone' => "denne email adresse er
allerede i vores database",
...
'make_breakthroughs' => 'Forskere kan bruge dine data til
